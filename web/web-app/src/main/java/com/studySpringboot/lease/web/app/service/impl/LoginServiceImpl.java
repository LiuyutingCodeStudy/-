...
import com.studySpringboot.lease.common.constant.RedisConstant;
import com.studySpringboot.lease.common.exception.LeaseException;
import com.studySpringboot.lease.common.result.ResultCodeEnum;
import com.studySpringboot.lease.common.utils.JwtUtil;
import com.studySpringboot.lease.model.entity.UserInfo;
import com.studySpringboot.lease.model.enums.BaseStatus;
import com.studySpringboot.lease.web.app.mapper.UserInfoMapper;
import com.studySpringboot.lease.web.app.service.LoginService;
import com.studySpringboot.lease.web.app.service.UserInfoService;
...
public class LoginServiceImpl implements LoginService {
    ...
    public void getSMSCode(String phone) {
        ...
        //3.发送短信(假装发送。实际上打印在控制台)，并将验证码存入Redis
